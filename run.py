...
import sys
import webbrowser
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "watchmen.settings")
#these pertain to your application
import watchmen.wsgi
import watchmen.urls
import watchmen.settings
import watchmen.models
import watchmen.views
